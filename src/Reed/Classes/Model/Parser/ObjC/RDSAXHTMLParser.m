...
@interface RDSAXHTMLParser ()

@property (nonatomic) id<RDSAXHTMLParserDelegate> delegate;
...
@implementation RDSAXHTMLParser
...
static void startElementSAX(void *context, const xmlChar *localname, const xmlChar **attributes) {
	...
	[(__bridge RDSAXHTMLParser *)context xmlStartElement:localname attributes:attributes];
}


static void	endElementSAX(void *context, const xmlChar *localname) {
	[(__bridge RDSAXHTMLParser *)context xmlEndElement:localname];
}


static void	charactersFoundSAX(void *context, const xmlChar *ch, int len) {
	[(__bridge RDSAXHTMLParser *)context xmlCharactersFound:ch length:(NSUInteger)len];
}


static void endDocumentSAX(void *context) {
	[(__bridge RDSAXHTMLParser *)context xmlEndDocument];
}
