...
@class RDSAXHTMLParser;

@protocol RDSAXHTMLParserDelegate <NSObject>

@optional

- (void)saxParser:(RDSAXHTMLParser *)SAXParser XMLStartElement:(const unsigned char *)localName attributes:(const unsigned char *_Nullable*_Nullable)attributes;

- (void)saxParser:(RDSAXHTMLParser *)SAXParser XMLEndElement:(nullable const unsigned char *)localName;

// Length is guaranteed to be greater than 0.
- (void)saxParser:(RDSAXHTMLParser *)SAXParser XMLCharactersFound:(nullable const unsigned char *)characters length:(NSUInteger)length;

- (void)saxParserDidReachEndOfDocument:(RDSAXHTMLParser *)SAXParser; // If canceled, may not get called (but might).

@end


@interface RDSAXHTMLParser : NSObject


- (instancetype)initWithDelegate:(id<RDSAXHTMLParserDelegate>)delegate;
