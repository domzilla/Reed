...
extension Data {
    ...
    var isProbablyHTML: Bool {
        ...
        if
            self.range(of: RSSearch.UTF8.lowercaseDoctype) != nil || self
                .range(of: RSSearch.UTF8.uppercaseDoctype) != nil
        {
            return true
        }

        if
            self.range(of: RSSearch.UTF16.lowercaseDoctype) != nil || self
                .range(of: RSSearch.UTF16.uppercaseDoctype) != nil
        {
            return true
        }
        ...
        let hasCommonHTMLElements = {
            // Check for div tags
            if
                self.range(of: RSSearch.UTF8.lowercaseDiv) != nil || self
                    .range(of: RSSearch.UTF8.uppercaseDiv) != nil ||
                    self.range(of: RSSearch.UTF16.lowercaseDiv) != nil || self
                    .range(of: RSSearch.UTF16.uppercaseDiv) != nil
            {
                return true
            }
            ...
            // Check for p tags
            if
                self.range(of: RSSearch.UTF8.lowercaseP) != nil || self.range(of: RSSearch.UTF8.uppercaseP) != nil ||
            ...
            // Check for span tags
            if
                self.range(of: RSSearch.UTF8.lowercaseSpan) != nil || self
                    .range(of: RSSearch.UTF8.uppercaseSpan) != nil ||
                    self.range(of: RSSearch.UTF16.lowercaseSpan) != nil || self
                    .range(of: RSSearch.UTF16.uppercaseSpan) != nil
            {
                return true
            }
