...
extension RSParsedFeedTransformer {
    fileprivate static func parsedItems(_ parsedArticles: Set<RSParsedArticle>) -> Set<ParsedItem> {
        // Create Set<ParsedItem> from Set<RSParsedArticle>

        Set(parsedArticles.map(self.parsedItem))
    }

    fileprivate static func parsedItem(_ parsedArticle: RSParsedArticle) -> ParsedItem {
    ...
    fileprivate static func parsedAuthors(_ authors: Set<RSParsedAuthor>?) -> Set<ParsedAuthor>? {
    ...
    fileprivate static func parsedAttachments(_ enclosures: Set<RSParsedEnclosure>?) -> Set<ParsedAttachment>? {
